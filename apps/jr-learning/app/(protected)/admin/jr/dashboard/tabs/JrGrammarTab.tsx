...
const GRAMMAR_STAGES = ["lesson", "practice"];

export default function JrGrammarTab({ sessions }: { sessions: Session[] }) {
            ...
            {expandedStudent === studentId && (
              <div className="mt-4 space-y-2">
                {data.sessions.map((session, idx) => {
                  const stageIndex = GRAMMAR_STAGES.indexOf(session.stage);
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-1 text-xs text-slate-600">
                        {stageIndex >= 0 && (
                          <>
                            {stageIndex + 1} / {GRAMMAR_STAGES.length} 단계
                          </>
                        )}
                      </div>
                    </div>
