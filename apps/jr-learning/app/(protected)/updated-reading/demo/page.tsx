// apps/web/app/(protected)/updated-reading/demo/page.tsx
"use client";
    ...
    <TestSectionLayout
      ...
      left={
        <article className="prose max-w-none text-sm leading-relaxed">
          <h2 className="mb-3 text-base font-semibold">The Mirror Test</h2>
          <div
            className="space-y-3"
      ...
      right={
        <div className="flex h-full flex-col gap-4 text-sm">
          <p className="font-semibold">What is the passage mainly about?</p>
          <form className="space-y-3">
            {choices.map((choice, idx) => (
              ...
              >
                <input type="radio" name="q13" className="mt-1" />
                <span>{choice}</span>
              </label>
            ))}
          </form>
