      ...
      >
        ...
        <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 8 }}>
          <div style={{ fontSize: 12, color: '#666' }}>
            {/* ?ˆë‚´ë¬?ëª¨ì?ë°”ì? ?•ë¦¬ */}
            ê³µê°œ ë²„í‚·(audio) ?¬ìš© ê¸°ì??…ë‹ˆ?? ë¹„ê³µê°?RLS ë²„í‚·?´ë©´ ê¶Œí•œ???†ì„ ??
            {` 'permission denied'`}ê°€ ?œì‹œ?????ˆì–´??
          </div>

          <select onChange={onSelect} style={{ marginTop: 6, width: '100%' }}>
            <option value="">{`-- ?Œì¼ ? íƒ --`}</option>
            {items
          ...
          <div style={{ marginTop: 8, fontSize: 12, color: '#6b7280' }}>
            ?¬ìƒ?€ ê³µê°œ URL ê¸°ë°˜?…ë‹ˆ?? ?¬ë‚´ë§?ê¶Œí•œ ?¤ì •???°ë¼ ?‘ê·¼???œí•œ?????ˆìŠµ?ˆë‹¤.
          </div>
        </div>
      </div>
    </div>
