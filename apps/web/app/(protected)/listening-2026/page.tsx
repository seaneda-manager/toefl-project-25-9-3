// apps/web/app/(protected)/listening-2026/page.tsx
...
export default function Listening2026Home() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      ...
      <SectionGuide
        storageKey="guide-seen-listening-2026"
        color="violet"
        icon="🎧"
        title="리스닝"
        ...
        nextAction={{ label: 'Study Mode 시작', href: '/listening-2026/study' }}
      />
