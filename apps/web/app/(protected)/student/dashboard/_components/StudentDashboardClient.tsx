    ...
    <main className="min-h-screen bg-slate-50">
      <div className="border-b bg-white p-4">
        <div className="mx-auto max-w-7xl px-6">
          <h1 className="text-3xl font-bold text-slate-900">{studentName}님의 학습</h1>
          <p className="text-slate-600 mt-1">Jr. Learning 진도를 확인합니다</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            ...
            <p className="text-xs text-slate-500 mt-3">
              {readingSessions.length > 0 ? "진행 중" : "할당된 과제 없음"}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            ...
            <p className="text-xs text-slate-500 mt-3">
              {grammarSessions.length > 0 ? "진행 중" : "할당된 과제 없음"}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            ...
            <p className="text-xs text-slate-500 mt-3">
              {listeningSessions.length > 0 ? "진행 중" : "할당된 과제 없음"}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow">
            ...
            <p className="text-sm text-slate-600 mb-2">
              {speakingWithFeedback} / {speakingSubmissions.length} 피드백완료
            </p>
            <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
              <div
            ...
            <p className="text-xs text-slate-500 mt-3">
              {speakingSubmissions.length > 0 ? "진행 중" : "할당된 과제 없음"}
            </p>
          </div>
        </div>
      </div>
