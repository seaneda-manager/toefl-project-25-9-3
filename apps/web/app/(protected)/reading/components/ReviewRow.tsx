  ...
  return (
    <div className="rounded-xl border border-gray-200 p-4 space-y-3 bg-white dark:bg-neutral-900 dark:border-neutral-800">
      <div className="font-medium text-gray-900 dark:text-gray-100">
        Q{q.number ?? ''}. {/* Î¨∏Ï†ú Î≥∏Î¨∏???∞Î°ú ?àÏúºÎ©??¨Í∏∞??Ï∂úÎ†• */}
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-2">
                ...
                {isCorrect && <span className="text-xs text-green-700 dark:text-green-300">?ïÎãµ</span>}
                {isSelected && !isCorrect && (
                  <span className="text-xs text-amber-700 dark:text-amber-300">???†ÌÉù</span>
                )}
              </div>
            </li>
          );
      ...
      {exp.clue_quote && (
        <div className="text-sm">
          <div className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Í∑ºÍ±∞ Î¨∏Ïû•</div>
      ...
      {(exp.why_correct || exp.why_others) && (
        <div className="space-y-2 text-sm">
          {exp.why_correct && (
            <div>
              <div className="font-semibold text-gray-900 dark:text-gray-100 mb-1">???ïÎãµ?∏Í??</div>
          ...
          {exp.why_others && (
            <div>
              <div className="font-semibold text-gray-900 dark:text-gray-100 mb-1">?§Î•∏ ?†ÌÉùÏßÄÍ∞Ä ?ÄÎ¶??¥Ïú†</div>
